...
Plugin URI: https://slangji.wordpress.com/wp-admin-bar-removal/
Description: disable admin bar or toolbar on WordPress 3.1+ to 4.5+ for all admin and user roles, completely remove code on front and back end with related user personal options settings, for minimize memory consumption and speed up loading of the admin control panel with new unified coding approach, without loosing logout and network multisite functionality: the configuration is Automatic and plugin is NoLogo!
Author: sLaNGjIs
 ...
 *
 * Copyright (C) 2010-2016 [sLaNGjIs](//slangji.wordpress.com/) (email: <slangjis [at] googlemail [dot] com>)
 *
