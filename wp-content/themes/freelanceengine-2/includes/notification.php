...
class Fre_Notification extends AE_PostAction
{
    ...
    function fre_notify_item($notify) {      
        ...
        switch ($type) {
            ...
            //     // render bid author data
            //     $author = '<a class="user-link" href="'. get_author_posts_url($project_author) .'">
            //             <span class="avatar-freelancer-notification">
            ...
            //     $content.= sprintf(__("%s is created by %s", ET_DOMAIN), $project_link, $author);
            //     break;
            //      case 'renew_project':
            ...
            //     $content.= sprintf(__("%s is renewed by %s", ET_DOMAIN), $project_link, $author);
            //     break;
