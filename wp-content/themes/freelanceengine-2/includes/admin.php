    ...
    function get_default_options() {
        ...
        return apply_filters('fre_default_setting_option', array(
            ...
            'bid_cancel_mail_template' => "<p>Hello [display_name],</p>
                                    <p>The Freelancer is canceled a bid on the project : [title].</p>
                                    <p>Sincerely,</p>
                                    <p>[blogname]</p>",
            'init' => 1
        ));
                ...
                <div class="et-main-main clearfix inner-content" id="wizard-sample">
                    ...
                    <div class="desc" style="padding-top:0px;">
                        <div class="title font-quicksand sample-title">
                            <a target="_blank" href="<?php echo admin_url( 'edit.php?post_type=project' ); ?>" ><?php _e('Project',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add new project types or modify the sample ones to suit your site style.',ET_DOMAIN) ?></span>
                        </div>
                        <div class="title font-quicksand sample-title">
                            <a target="_blank" href="<?php echo admin_url( 'edit-tags.php?taxonomy=project_category&post_type=project' ); ?>" ><?php _e('Project Categories',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add new categories or modify the sample data to match your freelance business.',ET_DOMAIN) ?></span>
                        </div>
                         <div class="title font-quicksand sample-title">
                            <a target="_blank" href="<?php echo admin_url( 'edit-tags.php?taxonomy=project_type&post_type=project' ); ?>" ><?php _e('Project Type',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add new project type or modify the sample data to match your freelance business.',ET_DOMAIN) ?></span>
                        </div>
                         <div class="title font-quicksand sample-title">
                            <a target="_blank" href="<?php echo admin_url( 'edit-tags.php?taxonomy=skill&post_type=project' ); ?>" ><?php _e('Skill',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add new skill or modify the sample data to match your freelance business.',ET_DOMAIN) ?></span>
                        </div>
                         <div class="title font-quicksand sample-title">
                            <a target="_blank" href="<?php echo admin_url( 'edit.php?post_type=fre_profile' ); ?>" ><?php _e('Profile',ET_DOMAIN) ?></a> <span class="description"><?php _e('Add new profile types or modify the sample ones to suit your site style.',ET_DOMAIN) ?></span>
                        </div>
                        <div class="title font-quicksand sample-title">
    ...
    function admin_setup() {
        ...
        $sections['freelancer'] = array(
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        'title' => __("The free bids number", ET_DOMAIN) ,
                        'id' => 'free-bid',
                        'class' => '',
                        'desc' => __("Enter the free bids number.", ET_DOMAIN)
                    ) ,
                    'fields' => array(
                        array(
                            'id' => 'ae_free_bid_number',
                            'type' => 'text',
                            'title' => __("The free bids number", ET_DOMAIN) ,
                            'name' => 'ae_free_bid_number',
                            'class' => 'option-item bg-grey-input',
                            'default'=> 0
                        )
                    )
            ...
            'groups' => array(
                ...
                array(
                    'args' => array(
                        ...
                        'class' => 'payment-gateway',
                        'name' => '',
                        'desc' => __("Send to employer when freelancer cancel a bid.", ET_DOMAIN),
                        'toggle' => true
                    ) ,
                    'fields' => array(
                        array(
